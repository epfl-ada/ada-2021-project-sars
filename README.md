...
* **Part 1**: Quantifying Media Coverage ✔️ 
  ...
  * Method 2: We perform text sentiment analysis on the quotations retrieved in the first method (on a presidential candidate basis) for each newspaper. See [Notebook](sentiment_analysis/exploratory_sentiment_analysis.ipynb):blue_book: for detailed information.
...
* :blue_book:[sentiment_analysis.ipynb](sentiment_analysis/exploratory_sentiment_analysis.ipynb): includes exploratory sentiment analysis with baseline implementation on the parsed [dataset](Data/). See notebook for detailed information.
